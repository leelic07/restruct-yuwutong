...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Renders and assigns an `el` property for each fill segment. Generic enough to work with different type.
	...
	// Builds the HTML needed for one fill segment. Generic enought o work with different type.
...
function getDraggedElMeta(el) {
	...
	// massage into correct data type
...
fcViews.agenda = View.extend({ // AgendaView
	...
	// Generates the HTML that goes before all other type of cells.
